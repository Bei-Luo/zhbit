...
subsequent line of a map contains data for a single building ¡ª 5 real numbers separated by spaces in
the following order:
...
buildings.
Output
Buildings are numbered according to where their data lines appear in the map¡¯s input data ¡ª building
